...
#python train.py --subject_id /scratch/aparna/ExAvatar_RELEASE/avatar/data/Custom/data/aparna_1080
python train.py --subject_id /ssd_scratch/cvit/aparna/ExAvatar_RELEASE/avatar/data/Custom/data/Ayan
